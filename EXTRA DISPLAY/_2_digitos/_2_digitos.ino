...
void loop() {  
  byte variable_mostrada = 70;
  
  byte decimales_variable = variable_mostrada/10;
  
  byte unidades_variable = variable_mostrada - decimales_variable*10;
  
  digitalWrite(12, HIGH);
  imprime_7_segmentos( decimales_variable);
  delay(8);
  digitalWrite(12, LOW);
  digitalWrite(11, HIGH);
  imprime_7_segmentos( unidades_variable);
  delay(8);
  digitalWrite(11, LOW);
  digitalWrite(9,HIGH);
}
